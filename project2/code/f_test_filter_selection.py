...
def main():
    ...
    filterd_images, scores, selected_pixel_idxs = f_score_filter(
        training_matrix, training_labels, 163, True
    )
    ...
    plt.show()
    plt.savefig("../figures/dim_filter/choosen_pixels.png")
    ...
    plt.show()
    plt.savefig("../figures/dim_filter/F_score_pre_pixel")
