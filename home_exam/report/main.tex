...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.95\textwidth]{../figures/problem4/class_balance_extreme.pdf}
	\end{center}
	\caption{}\label{fig:}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.95\textwidth]{../figures/problem4/performance_boxplot.pdf}
	\end{center}
	\caption{}\label{fig:}
\end{figure}
\begin{figure}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{../figures/problem4/bayes_comp.pdf}
	\end{center}
	\caption{}\label{fig:}
\end{figure}
